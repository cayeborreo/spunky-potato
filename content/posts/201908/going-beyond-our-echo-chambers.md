---
title: Going Beyond Our Echo Chambers
...
**None of them won.** Among the five, Diokno [placed highest](https://halalanresults.abs-cbn.com/candidate/diokno-chel) at #21. Gutoc placed #25. In a race where only 12 senators are to be chosen, ranking 20+ indicates lots of legroom for the campaign's improvement (either that, or the results were heavily rigged 🤔).

Which begs the question: If these candidates had such a strong online presence in a social media platform with 10 million Filipino users, how and where, then, did it go wrong?
...
<figure>
<blockquote>
<p>The thing is: When it comes to advocacies, the people we most need to reach out to aren’t the ones on the same side of the spectrum—it’s the ones at the middling or far end of it. And reaching them is just the first obstacle.</p>
</blockquote>
</figure>

**Echo chambers are not inherently bad.** I personally live in one, and it gets really handy for when I want to see curated content. I have two Twitter accounts: the original one was created way back 2010, and the more "professional" one just last year. In my newer account, I've decided to follow all the people whose work I'm interested in: public health officials, people (especially women) in tech, academicians, and advocacy groups. My feed magically updates me with the things I care most about.

We can use echo chambers to our advantage. <mark>The problem, however, lies in thinking we can expect an attitude shift by staying in them.</mark>
...
**The next obstacle we'll be crashing head-on is outright disagreement, even before we've made our case.**

One common cognitive coping mechanism we humans have is **<mark>confirmation bias</mark>**, where we tend to only listen to things that confirm our core belief systems. Anything that threatens or challenges those core systems, we instinctively repel and reason out of.
...
So if we're battling polarized environments and natural biases that are hard to ignore, how do we forward our advocacies and engage other people better? Here's a list of good starting points:
<br />
<br />
...
<figure>
  <blockquote>
    <p>“Arguments are more convincing when they rest on a good knowledge of the audience, taking into account <b>what the audience believes, who they trust, and what they value</b>.”</p>
    <footer>
    <cite>— Hugo Mercier, <i>How can you change someone’s mind</i> (TED-Ed)</cite>
    </footer>
  </blockquote>
</figure>
...
This can be seen in reality as we examine which of the two feeds various campaigns. Anti-vaxxers scare parents and prompt them to _not_ vaccinate by saying vaccines "cause autism", "contain toxic content", and overall "do more harm than good" even when scientific evidence has debunked all these; on the other hand, images of yellow ribbons and throngs of people in EDSA flashing the "L" sign became important symbols of hope during the 1986 People Power Revolution, which prompted people to act and join mobilizations on the streets.
<br />
<br />
...
In the end you might or might not have the same conviction, but that window of open-mindedness is an exercise towards a healthy view on what can be up for debate.

---

If there's a lesson to be learned from #Eleksyon2019, it's that echo chambers = comfort zones. They're nice and cozy, but the real campaigns plus problems that need to be talked about and their corresponding solutions are found beyond them—[preferably offline](https://www.tandfonline.com/doi/full/10.1080/1369118X.2016.1218526). They'll always be there, though, when we need to recharge and regather support and affirmation from time to time.
...
1. **[Facts Aren't Enough: The Psychology of False Beliefs](https://www.npr.org/2019/07/18/743195213/facts-arent-enough-the-psychology-of-false-beliefs)** — a podcast from [Hidden Brain](https://www.npr.org/series/423302056/hidden-brain) (listen on Google Podcasts or Spotify, for free)
2. **[‘Like minded’: the effect of echo chambers in development communications](http://wpmu.mah.se/nmict182group3/2018/10/16/echo-chambers-and-development-communications/)** by Alexandra of Quartet4Development
3. **[Echo chambers and viral misinformation:](https://www.researchgate.net/publication/327783592_Echo_chambers_and_viral_misinformation_Modeling_fake_news_as_complex_contagion) [Modeling fake news as complex contagion](https://www.psypost.org/2018/10/study-uncovers-how-echo-chambers-provide-the-initial-fuel-for-misinformation-to-go-viral-52340)** by Petter Tornberg
4. **[How can you change someone's mind? (hint: facts aren't always enough)](https://www.youtube.com/watch?v=58jHhNzUHm4)** by Hugo Mercier from TED-Ed
5. **[Why you think you're right — even if you're wrong](https://www.ted.com/talks/julia_galef_why_you_think_you_re_right_even_if_you_re_wrong/transcript?referrer=playlist-for_the_love_of_facts)** — a TED talk by Julia Galef
6. **[Social media and political discussion: when online presence silences offline conversation](https://www.tandfonline.com/doi/full/10.1080/1369118X.2016.1218526)** by Keith Hampton, Inyoung Shin and Weixu Lu
